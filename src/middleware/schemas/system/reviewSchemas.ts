...
export const receivedReviewsQuerySchema = Joi.object({
  ...
  course_id: Joi.number()
    ...
    .optional()
    .messages({
      'number.base': MESSAGES.VALIDATION.COMMON.COURSE_ID_INVALID,
      'number.integer': MESSAGES.VALIDATION.COMMON.COURSE_ID_INVALID,
      'number.min': MESSAGES.VALIDATION.COMMON.COURSE_ID_INVALID
    }),
